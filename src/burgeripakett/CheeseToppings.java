...
public class CheeseToppings extends Toppings {  //Inheritance
    ...
    CheeseToppings(String topping1, String topping2, String topping3, String topping4, double topping1Price, double topping2Price, double topping3Price, double topping4Price){
